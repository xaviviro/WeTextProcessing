...
from tn.galician.rules.cardinal import Cardinal
from tn.galician.rules.char import Char
from tn.galician.rules.whitelist import Whitelist
...
class Normalizer(Processor):
    ...
    def __init__(self, cache_dir=None, overwrite_cache=False):
        super().__init__(name="gl_normalizer")
        if cache_dir is None:
            cache_dir = files("tn")
        self.build_fst("gl_tn", cache_dir, overwrite_cache)
