...
from tn.catalan.rules.cardinal import Cardinal
from tn.catalan.rules.char import Char
from tn.catalan.rules.whitelist import Whitelist
...
class Normalizer(Processor):
    ...
    def __init__(self, cache_dir=None, overwrite_cache=False):
        super().__init__(name="ca_normalizer")
        if cache_dir is None:
            cache_dir = files("tn")
        self.build_fst("ca_tn", cache_dir, overwrite_cache)
